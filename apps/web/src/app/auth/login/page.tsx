...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    ...
    window.location.href = `${process.env.NEXT_PUBLIC_API_URL || 'https://nedlan-ai-api.onrender.com'}/api/auth/google`;
  };

  const handleFacebookLogin = () => {
    showToast('יועבר לאימות Facebook...', 'info');
    // In production, this would redirect to Facebook OAuth
    window.location.href = `${process.env.NEXT_PUBLIC_API_URL || 'https://nedlan-ai-api.onrender.com'}/api/auth/facebook`;
  };
